...
//            +THUTHU_COLUMN_GT + " INTEGER,"
    ...
    public String SACH_CREATE_TABLE = "CREATE TABLE "+SACH_TABLE_NAME+"("
            ...
            +SACH_COLUMN_MALOAI+" INTEGER REFERENCES "+ LOAISACH_TABLE_NAME+"("+LOAISACH_COLUMN_MALOAI+")"+" ON DELETE CASCADE ON UPDATE CASCADE)";
    ...
    public String PHIEUMUON_CREATE_TABLE = "CREATE TABLE "+PHIEUMUON_TABLE_NAME+"("
            ...
            +PHIEUMUON_COLUMN_MATT + " VARCHAR REFERENCES "+THUTHU_TABLE_NAME+"("+THUTHU_COLUMN_MATT+")"+" ON DELETE CASCADE ON UPDATE CASCADE,"
            + PHIEUMUON_COLUMN_MATV + " INTEGER REFERENCES "+THANHVIEN_TABLE_NAME+"("+THANHVIEN_COLUMN_MATV+")"+" ON DELETE CASCADE ON UPDATE CASCADE,"
            +PHIEUMUON_COLUMN_MASACH+" INTEGER REFERENCES "+ SACH_TABLE_NAME+"("+SACH_COLUMN_MASACH+")" +" ON DELETE CASCADE ON UPDATE CASCADE,"
